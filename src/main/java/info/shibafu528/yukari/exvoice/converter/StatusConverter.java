package info.shibafu528.yukari.exvoice.converter;
...
public class StatusConverter {
    ...
    public static Message toMessage(MRuby mRuby, twitter4j.Status status) {
        ...
        values.put("created", status.getCreatedAt().getTime() / 1000);
        values.put("modified", status.getCreatedAt().getTime() / 1000);
